...
//    simpleSort = simpleList.sort(compareFn)

//    console.log(simpleSort)
//    console.log(simpleList)

//    function searchList (a,query) {
//     function searchCallback (string) {
//         return string.toLowerCase().includes(query.toLowerCase());
//     }
//     return a.filter(searchCallback);
//    }

//    let filteredList = searchList(simpleList, "b")
//    console.log(filteredList)

//    filteredList = searchList(simpleList, "an")
//    console.log(filteredList) 
